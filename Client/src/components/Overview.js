        ...
        <div>
            ...
            <div className='w-full flex flex-col gap-4'>
                ...
                <div className='w-1/2 flex flex-col gap-4'>
                    ...
                    <InputFormV2 value={payload.priceNumber} setValue={setPayload} small='Nhập đầy đủ số, ví dụ 1 là 1 triệu/tháng' label='Giá cho thuê' unit='đồng' name='priceNumber' />
