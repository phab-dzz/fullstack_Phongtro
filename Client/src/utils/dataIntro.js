export const text = {
    title: 'Tại sao lại chọn EZROOM.PA#N?',
    description: 'Chúng tôi biết bạn có rất nhiều lựa chọn, nhưng EZROOM.PA#N tự hào là trang web đứng top google về các từ khóa: ',
